...
public class DistancedEnemy : MonoBehaviour
{
    [Header("Movement")]
    public float Speed;
    ...
    public void Update()
    {
        ...
        Vector3 faceDireciton = player.transform.position - transform.position;
        float rotationAngle = Mathf.Atan2(faceDireciton.y, faceDireciton.x) * Mathf.Rad2Deg + 90;
